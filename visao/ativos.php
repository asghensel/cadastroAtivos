            ...
            if($ativo['statusAtivo']=="S"){
              ?>
                                    <div class="inativo" onclick="muda_status('N', '<?php echo $ativo['idAtivo'] ?>')">
                                        ...
                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Alterar Status!"></i>
                                    </div>
                                    <?php      
            }else{
               ?>
          ...
          ?>
                                ...
                                <div class="edit">
                                    <i class="bi bi-pencil-square"
                                        onclick="editar('<?php echo $ativo['idAtivo'] ?>')"
                                ...
                                <div class="infos">
                                    <i class="bi bi-file-earmark-medical-fill" data-bs-target="#modalInfos"
                                    data-bs-toggle="modal"  data-bs-toggle="tooltip" data-bs-placement="top" title="Ver Informações!"
